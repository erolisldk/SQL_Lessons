...
/*
Arkadaslar technical support sayfasinda cihan hocaya ders saatleri ile ilgili mesaj yazdim 
altini yorum ile doldurabilirseniz iyi olur. eger istekli iseniz
*/
...
--SORU2; musteriler tablosunda id degeri 2 den büyük olan, ilk 3 veriyi listeleyiniz
...
--INTERSECT : Iki sorgu ifadesinin kesisim degerini bize verir.
...
INSERT INTO isciler VALUES('Harun Sarsılmaz','Bursa', 5200, 'Honda');
 ...
 select isim, sehir from isciler where isim ='Murat Oz' intersect
 ...
 -- ilk sorguda olup ikinci sorguda olmayan degerleri listeleyiniz 
  ...
  select isim, sehir from isciler where isim ='Murat Oz' except
 
 select isim, sehir from isciler where sehir!= 'Istanbul';
 
 --INTERSECT : Ortaklari verir
--EXCEPT : Ortaklari cikarir
